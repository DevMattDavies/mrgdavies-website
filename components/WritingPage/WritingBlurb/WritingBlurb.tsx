...
export const WritingBlurb: React.FC = () => {
    return (
      <div className={styles.writing__titleContainer}>
        <div className={styles["writing__title--desktop"]}>
          ...
          <p className={styles.writing__bodyText}>
            ...
            playwriting competition and subsequent work for the stage includes
            the comedies Reality (Royal & Derngate, Northampton) and This
            American Carnage. He has also written narrative non-fiction for
            worldwide television (Netflix no.1), had short stories and poetry
            commissioned and published, and contributes regular essays for
            theatre programmes. <br />
            <br />
            ...
            thriller Domino Island for posthumous publication. Outback, the
